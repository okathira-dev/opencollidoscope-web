...
| **筐体・Web 配置** | [layout-specs/README.md](layout-specs/README.md)（確定後） | [hardware-layout.md](hardware-layout.md)（暫定図・座標系） |
...
- **配置**: ワイヤーフレーム確定まで暫定。既存 AI 配置分析は信用しない。
...
| [layout-specs/](layout-specs/README.md) | ワイヤーフレーム + YAML | 電子配線、管轄表 |
